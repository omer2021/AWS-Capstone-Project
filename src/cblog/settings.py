...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.cp69oj1kxh0f.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesomersblog' # please enter your s3 bucket name
